...
//Automation Script to  Created Date in Product Details Page

public class ProductCatalogTest_14 extends BaseClassTest {
	...
	@Test(priority = 3)
	public void CaptureCreatedDate() {

		logger = extentReports.createTest("Capture Created Date");

		ItemCatalog catalogBulkUploadAction = PageFactory.initElements(driver, ItemCatalog.class);

		logger.info("Product Created Date");

		System.out.println("The Share icon is display ----- " + catalogBulkUploadAction.createdDate());

		logger.pass("Product Created Date Capture Successfully");
