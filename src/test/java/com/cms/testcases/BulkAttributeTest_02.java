 ...
 *
 */
// Automation Script for Bulk Attribute (Upload XSL File) of CMS

public class BulkAttributeTest_02 extends BaseClassTest {
	
	Robot robot;
	String excelFileWithValue = "D:\\Trezi\\Bulk Attribute File\\BulkAttributeCodeWithValue.xlsx";
	...
	public void uploadExcelFile() {
		...
		logger.info("Ready to Upload Excel File");
		...
		StringSelection stringSelection = new StringSelection(excelFileWithValue);
		...
		logger.pass("Excel File Uploaded");
	}
