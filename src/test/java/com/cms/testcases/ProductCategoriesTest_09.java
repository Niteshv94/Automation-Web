...
//Automation Script to Edit/Update Product Sub-category
public class ProductCategoriesTest_09 extends BaseClassTest{
	...
	public void searchProductCategoryInTextbox() {
		...
		try {
			productCategories.searchAndAddProductSubCategory(excelDataProvider.getProductCategory("Product Categories", 3, 3));
		} catch (InterruptedException e) { 
			System.out.println(e.getMessage());
		}
	...
	public void updateProductCategoryInTextbox() {
		...
		try {
			productCategories.addProductSubCategory(excelDataProvider.updateProductCategory("Product Categories", 3, 0));
		} catch (InterruptedException e) {
			System.out.println(e.getMessage());
		}
	...
	public void searchProductClustersInSearchbox() throws InterruptedException {
		...
		System.out.println("Error message when an existing Product Cluster is entered ---- " + productCategories.captureProductCategoriesMessage());
